...
export default function AssetSwapModal({
  ...
  const toAssetData = availableAssetsWithPrices.find(
    (a) => a.symbol === toAsset,
  );
  ...
  return (
    <>
                ...
                {step === 1 && (
                  ...
                  >
                    ...
                    {errors.toAsset && (
                      ...
                      >
                        <p
                          className={`text-xs text-center ${isDark ? "text-red-400" : "text-red-600"}`}
                        >
                          {errors.toAsset}
                        </p>
                      </div>
                      ...
                      style={
                        isDark
                          ? {
                              ...
                              boxShadow:
                                "0 4px 12px -2px rgba(6, 182, 212, 0.4)",
                              border: "1px solid rgba(255, 255, 255, 0.1)",
                            }
                          : {
                              background:
                              ...
                              boxShadow:
                                "0 4px 12px -2px rgba(14, 116, 144, 0.3)",
                ...
                {step === 2 && (
                  ...
                  >
                    ...
                    <div>
                          ...
                          onClick={() => {
                            ...
                            if (!isNaN(currentValue) && currentValue > 0) {
                              if (inputMode === "crypto") {
                                ...
                                const usdValue =
                                  currentValue * currentAssetPrice;
                                const fiatValue = convertAmount(usdValue);
                                setFromAmount(fiatValue.toFixed(2));
                              } else {
                      ...
                      {errors.fromAmount && (
                        <p
                          className={`text-xs mt-1.5 ${isDark ? "text-red-400" : "text-red-600"}`}
                        >
                          {errors.fromAmount}
                        </p>
                      )}
                      <div className="flex items-center justify-between mt-1.5">
                        ...
                        >
                          Available: {formatCryptoAmount(asset.amount, 14)}{" "}
                          {asset.symbol}
                        </p>
                    ...
                    {fromAmount && parseFloat(fromAmount) > 0 && (
                      ...
                      >
                        <div
                          className={`text-xs mb-1.5 ${isDark ? "text-gray-400" : "text-gray-600"}`}
                        >
                          You will receive
                        </div>
                        <div className="flex items-center gap-2">
                          ...
                          <span
                            className={`text-xl font-bold ${isDark ? "text-cyan-400" : "text-cyan-600"}`}
                          >
                            {formatReceiveAmount()}
                          </span>
                          <span
                        ...
                        <div className="space-y-1.5 text-xs">
                          ...
                          <div className="flex justify-between">
                            ...
                            >
                              {(() => {
                                const rate = getConversionRate();
                                const cryptoAmt = parseFloat(
                                  getCryptoAmount() || "0",
                                );
                                const fee =
                                  cryptoAmt * rate * (conversionFee / 100);
                                return isFinite(fee) && !isNaN(fee)
                                  ? fee.toFixed(8)
                                  : "0.00000000";
                              })()}{" "}
                              {toAsset}
                ...
                {step === 3 && (
                  ...
                  >
                    <div className="text-center">
                      ...
                      <h2
                        className={`text-base font-bold mb-0.5 ${isDark ? "text-white" : "text-gray-900"}`}
                      >
                        Confirm Swap
                      </h2>
                      <p
                    ...
                    >
                      ...
                      <div
                        className={`text-sm my-0.5 ${isDark ? "text-cyan-400" : "text-cyan-600"}`}
                      >
                        ↓
                      </div>
                      <div className="flex items-center justify-center gap-1.5">
                        <CryptoIcon symbol={toAsset} size="sm" />
                        <div
                          className={`text-base font-bold ${isDark ? "text-cyan-400" : "text-cyan-600"}`}
                        >
                ...
                {step === 4 && successData && (
                  ...
                  >
                    <div className="text-center">
                      ...
                      <h2
                        className={`text-lg font-bold mb-0.5 ${isDark ? "text-white" : "text-gray-900"}`}
                      >
                        Swap Successful!
                      </h2>
                      <p
                    ...
                    >
                      ...
                      <div
                        className={`text-base my-1 ${isDark ? "text-cyan-400" : "text-cyan-600"}`}
                      >
                        ↓
                      </div>
                      <div className="flex items-center justify-center gap-2 mb-0.5">
                    ...
                    >
                      <Check
                        className={`w-3.5 h-3.5 ${isDark ? "text-green-400" : "text-green-600"}`}
                      />
                      <span
      ...
      {/* Asset Selection Modal - Full Screen Popup */}
      <AnimatePresence>
        {showAssetSelectionModal && (
          <motion.div
            key="asset-selection-modal"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          >
            <motion.div
              ...
              className="w-full max-w-md max-h-[80vh] flex flex-col rounded-2xl overflow-hidden m-4"
              style={
                isDark
                  ? {
                      background:
              ...
              >
                <div className="relative">
                  ...
                  <input
                    ...
                    autoFocus
                    className={`w-full rounded-lg pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500 ${isDark ? "bg-slate-700 text-white placeholder-gray-400" : "bg-gray-100 text-gray-900 placeholder-gray-500"}`}
                  />
                </div>
              </div>
                      ...
                      className={`w-full p-4 flex items-center gap-3 transition-colors border-b ${
                        toAsset === a.symbol
                          ...
                          : isDark
                            ...
                            : "hover:bg-gray-100/80 border-gray-200/50"
                      }`}
                    >
                      <div
                      ...
                      <div className="text-left flex-1">
                        ...
                        <div
                          className={`text-sm ${isDark ? "text-gray-400" : "text-gray-600"}`}
                        >
                          {a.symbol} • {formatAmount(a.price, 2)}
                        </div>
                      </div>
                      {toAsset === a.symbol && (
                        <Check
