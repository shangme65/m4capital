                      ...
                      <PushNotificationProvider>
                        ...
                        <div className="flex h-screen relative bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
                          ...
                          <div className="flex-1 flex flex-col overflow-hidden">
                            ...
                            <main className="flex-1 overflow-x-hidden overflow-y-auto p-2 sm:p-4 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
