...
export default function TestimonialSlider() {
  ...
  const prev = () =>
    setCurrentIndex(
      (p) => (p - 1 + allTestimonials.length) % allTestimonials.length,
    );

  return (
    <div
      className={`absolute bottom-24 right-4 md:bottom-24 md:right-4 z-[7] w-72 backdrop-blur-md border rounded-lg p-3 hidden xl:block shadow-lg ${
        isDark
