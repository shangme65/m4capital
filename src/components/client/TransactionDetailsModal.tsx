...
export default function TransactionDetailsModal({
  ...
  const getCurrencyAccentColor = (
    ...
    return (
      colors[currency] || { primary: "#6366f1", glow: "rgba(99,102,241,0.4)" }
    );
  };
        ...
        <>
          ...
          >
            ...
            >
              ...
              <div
                className={`flex items-center justify-between px-3 py-2 sticky top-0 backdrop-blur-sm z-20 ${
                  isDark
                    ? "border-b border-gray-700 bg-gray-900/95"
              ...
              <div
                className={`relative p-3 pb-6 ${
                  isDark
                    ...
                    : "bg-gradient-to-r from-blue-100 via-purple-50 to-pink-50"
                }`}
              >
                <div
                    ...
                    style={
                      isDark
                        ...
                        : {
                            ...
                            boxShadow:
                              "0 10px 35px -8px rgba(0,0,0,0.25), inset 0 1px 0 rgba(255,255,255,1)",
                            border: "1px solid rgba(0,0,0,0.1)",
                          }
                    }
                  >
                    <label
                      className={`block text-[10px] font-medium mb-1.5 uppercase tracking-wider ${
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        onClick={() =>
                          copyToClipboard(transaction.id, "transactionId")
                        }
              ...
              <div className="p-3 pt-2">
                ...
                <div className="space-y-2 mb-3">
                  ...
                  transaction.toAsset ? (
                    ...
                    <>
                      ...
                      >
                        <label
                          className={`block text-[10px] font-semibold mb-1 uppercase tracking-wider ${
                      ...
                      <div className="space-y-2">
                        ...
                        {transaction.receiverEmail && (
                          <div>
                            ...
                            <div
                              className={`rounded-lg px-2.5 py-1.5 text-xs break-all ${
                                isDark
                                  ? "bg-black/40 border border-gray-600/30 text-white"
                                  : "bg-gray-100 border border-gray-300 text-gray-900"
                              }`}
                    ...
                    <div className="space-y-2">
                      {transaction.hash && (
                        <div>
                          ...
                          <div className="flex items-center gap-2">
                            <div
                              className={`flex-1 rounded-lg px-2.5 py-1.5 font-mono text-xs break-all ${
                                isDark
                                  ? "bg-black/40 border border-gray-600/30 text-white"
                                  : "bg-gray-100 border border-gray-300 text-gray-900"
                              }`}
                      ...
                      {transaction.network && (
                        <div>
                          ...
                          <div
                            className={`font-semibold text-xs rounded-lg px-2.5 py-1.5 ${
                              isDark
                                ? "bg-black/40 border border-gray-600/30 text-white"
                                : "bg-gray-100 border border-gray-300 text-gray-900"
                            }`}
                      ...
                      {transaction.confirmations !== undefined && (
                        <div>
                          ...
                          <div className="flex items-center gap-2">
                            <div
                              className={`flex-1 rounded-full h-2 overflow-hidden border ${
                                isDark
                            ...
                            <div
                              className={`flex-shrink-0 font-bold text-xs rounded-lg px-2 py-0.5 border ${
                                isDark
                ...
                {transaction.description && (
                  ...
                  >
                    <h3
                      className={`font-semibold text-xs mb-1.5 flex items-center gap-1.5 ${
                        isDark ? "text-white" : "text-gray-900"
                      }`}
                    >
                      <svg
            ...
            >
              <div className="flex gap-1.5 justify-end">
                <button
                  onClick={onClose}
                  className={`py-1.5 px-3 rounded-lg font-medium text-xs transition-all active:scale-95 ${
                    isDark ? "text-white" : "text-gray-900"
                  }`}
                  style={
                    isDark
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white py-1.5 px-3 rounded-lg font-medium text-xs transition-all active:scale-95 shadow-sm hover:shadow-orange-500/40"
                >
                  Download Receipt
                </button>
                {transaction.hash && (
                  <button
                    ...
                    className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white py-1.5 px-3 rounded-lg font-medium text-xs transition-all active:scale-95 shadow-sm hover:shadow-blue-500/40"
                  >
                    View on Explorer
                  </button>
                )}
