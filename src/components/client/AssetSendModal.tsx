...
export default function AssetSendModal({
  ...
  const executeTransfer = async () => {
    ...
    try {
      ...
      const recipient = data.recipientName || sendData.destination;
      ...
      addTransaction({
        ...
        status: "completed",
        description: `Sent ${amount.toFixed(8)} ${asset.symbol} to ${recipient}`,
      });

      addNotification({
        type: "transaction",
        title: `${asset.symbol} Sent`,
        message: `Successfully sent ${amount.toFixed(8)} ${asset.symbol} to ${recipient}`,
                        ...
                        <div className="mt-3 space-y-2">
                              ...
                              isDark
                                ? {
                                    background:
                                      "linear-gradient(145deg, #1e293b 0%, #0f172a 50%, #1e293b 100%)",
                                    boxShadow:
                                      "0 8px 20px -4px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.1)",
                                    border:
                                ...
                                : {
                                    background:
                                      "linear-gradient(145deg, #ffffff 0%, #f8fafc 50%, #ffffff 100%)",
                                    boxShadow:
                                      "0 8px 20px -4px rgba(0, 0, 0, 0.12), inset 0 1px 0 rgba(255, 255, 255, 1)",
                                    border: "1px solid rgba(0, 0, 0, 0.08)",
                                  }
                            }
                          >
                          ...
                          {!receiverVerified && (
                            ...
                            >
                              ...
                              <span>
                                This account is not verified. Please
                      ...
                      <button
                        onClick={() => {
                          if (inputMode === "crypto") {
                            ...
                            const maxFiat = convertAmount(
                              asset.amount * asset.price,
                            );
                            setSendData((prev) => ({
                              ...prev,
                              amount: maxFiat.toFixed(2),
                            }));
                          }
                        }}
              ...
              {showConfirmDialog && (
                ...
                >
                  <motion.div
                    ...
                    className={`rounded-2xl p-5 shadow-2xl max-w-xs w-full ${
                      isDark
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          {receiverVerified && (
                            <VscVerifiedFilled className="w-3.5 h-3.5 text-blue-400" />
                          )}
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between gap-2">
                        ...
                        >
                          {(getCryptoAmount() + transferFee).toFixed(8)}{" "}
                          {asset.symbol}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex space-x-2">
                      <button
                        ...
                        disabled={isSending}
                        className={`flex-1 py-1.5 px-3 rounded-lg text-xs font-medium transition-colors disabled:opacity-50 ${
                          isDark
                      ...
                      <button
                        ...
                        disabled={isSending}
                        className="flex-1 py-1.5 px-3 rounded-lg text-xs font-bold text-white transition-all disabled:opacity-60"
                        style={{
                          background:
